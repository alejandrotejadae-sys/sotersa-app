...
function etiquetaRol(rol: string) { return ({ admin: "Administrador", supervisor: "Supervisor", guardia: "Guardia", cliente: "Cliente" } as Record<string, string>)[rol] ?? rol; }
