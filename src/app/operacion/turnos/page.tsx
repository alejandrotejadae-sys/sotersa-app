...
export default async function PaginaTurnos() {
  ...
  return (
    <main className="min-h-dvh bg-[#020b18] text-white"><div className="mx-auto min-h-dvh w-full max-w-[1280px] bg-[radial-gradient(circle_at_50%_-5%,rgba(0,128,255,0.14),transparent_34%),linear-gradient(180deg,#020b18,#031226_55%,#020b18)] px-4 pb-10 pt-[max(1rem,env(safe-area-inset-top))] lg:px-8">
      ...
      <section className="mt-5"><p className="flex items-center gap-2 text-base font-medium text-[#0788ff]"><IconoTurno className="h-6 w-6" /> Gestión operativa</p><div className="mt-2 flex flex-wrap items-end justify-between gap-3"><div><h1 className="text-3xl font-bold lg:text-4xl">Turnos y asistencia</h1><p className="mt-1 text-sm text-slate-400">Programación, cobertura y aperturas de puesto en tiempo real.</p></div><Link href="/operacion/turnos/mes" className="inline-flex min-h-11 items-center gap-2 rounded-xl border border-[#0788ff]/40 bg-[#0788ff]/12 px-4 text-sm font-semibold text-[#65c8ff]"><IconoTurno className="h-5 w-5" /> Ver cuadrante del mes</Link></div></section>
