  ...
  return (
    <main className="min-h-dvh bg-[#020b18] text-white">
      <div className="mx-auto min-h-dvh w-full max-w-[1440px] border-x border-white/[0.04] bg-[radial-gradient(circle_at_50%_-5%,rgba(0,128,255,0.14),transparent_34%),linear-gradient(180deg,#020b18,#031226_55%,#020b18)] shadow-2xl shadow-black/40">
        <header className="flex items-center justify-between gap-5 px-5 pb-4 pt-[max(1rem,env(safe-area-inset-top))] lg:px-8"><Marca tamano="panel" /><nav className="hidden items-center gap-1 lg:flex"><EnlaceSuperior href="/admin" texto="Inicio" activo/><EnlaceSuperior href="/operacion/personal" texto="Personal"/><EnlaceSuperior href="/operacion/turnos" texto="Turnos"/><EnlaceSuperior href="/operacion/rondas" texto="Rondas"/><EnlaceSuperior href="/operacion/novedades" texto="Novedades"/><EnlaceSuperior href="/operacion/reportes" texto="Reportes"/><EnlaceSuperior href="/operacion/usuarios" texto="Usuarios"/><EnlaceSuperior href="/supervisor" texto="Supervisor"/><EnlaceSuperior href="/operacion/clientes" texto="Clientes"/></nav><div className="flex items-center gap-2"><span className="flex items-center gap-2 rounded-full border border-emerald-500/25 bg-emerald-500/10 px-3 py-2 text-xs font-medium text-emerald-300"><Pulso /> En línea</span><Link href="/mi-perfil" aria-label="Abrir mi perfil" className="grid h-10 w-10 place-items-center rounded-full border border-[#27425e] bg-[#07172a] text-[#49b6ff]"><IconoPersona className="h-5 w-5" /></Link></div></header>

        <div className="grid grid-cols-1 gap-4 px-4 pb-28 lg:grid-cols-12 lg:px-8 lg:pb-10">
          <section className="px-1 pt-1 lg:col-span-12"><p className="flex items-center gap-2 text-base font-medium text-[#0788ff]"><IconoEscudoOk className="h-6 w-6" /> Central operativa</p><h1 className="mt-2 text-[2rem] font-bold leading-tight tracking-tight lg:text-4xl">Buenos días, {nombre}</h1><p className="mt-1 text-base text-slate-400">Todo el control en un solo lugar</p></section>
          ...
          <section className="rounded-2xl border border-[#27425e] bg-[#07172a]/95 p-4 lg:col-span-7"><div className="flex items-center justify-between"><h2 className="text-lg font-semibold">Operación en tiempo real</h2><button type="button" className="flex items-center gap-1 text-sm font-medium text-[#0788ff]">Ver mapa <IconoFlecha className="h-4 w-4" /></button></div><MapaCentral /></section>

          <section className="rounded-2xl border border-[#27425e] bg-[#07172a]/95 p-4 lg:col-span-5"><h2 className="text-lg font-semibold">Acciones rápidas</h2><div className="mt-3 grid grid-cols-2 gap-3"><Accion href="/operacion/rondas" icono={<IconoCiclo className="h-7 w-7" />} texto="Rondas"/><Accion href="/operacion/novedades" icono={<IconoLista className="h-7 w-7" />} texto="Incidentes"/><Accion icono={<Camara className="h-7 w-7" />} texto="Cámaras"/><Accion href="/operacion/novedades?filtro=emergencias" icono={<IconoAlerta className="h-7 w-7" />} texto="Alertas"/><Accion href="/operacion/turnos" icono={<IconoTurno className="h-7 w-7" />} texto="Turnos"/><Accion href="/operacion/reportes" icono={<IconoLista className="h-7 w-7" />} texto="Reportes"/></div></section>
